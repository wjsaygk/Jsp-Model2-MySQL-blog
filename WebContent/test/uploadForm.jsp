...
<body>
	...
	<form action="uploadAction.jsp" method="POST"
		...
		username : <input type="text" name="username" /> <br /> Image : <input
			id="img__input" type="file" name="userProfile" /> <br /> <input
	...
	<script>
		...
		function handleImgFile(e) {
			...
			consloe.log(e.target.files);
			consloe.log(e.target.files[0]);
